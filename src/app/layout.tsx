...
export const metadata: Metadata = {
  title: "Bevel Marketing | LA Boutique Marketing Agency",
  description: "Award-winning boutique marketing agency in Los Angeles. Brand strategy, creative design, and social media marketing for ambitious brands.",
  keywords: ["marketing agency Los Angeles", "boutique marketing", "brand strategy", "creative design", "social media marketing"],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Bevel Marketing | LA Boutique Marketing Agency",
    description: "Award-winning marketing strategies tailored for ambitious brands. We combine creative excellence with data-driven insights.",
    type: "website",
    siteName: "Bevel Marketing",
  },
  twitter: {
    card: "summary_large_image",
    title: "Bevel Marketing | LA Boutique Marketing Agency",
    description: "Elevate your brand's story with our award-winning marketing strategies.",
  },
};
